...
//            cityAddress=city.substring(city.indexOf("省")+1, city.indexOf("市"));
        ...
        public static String stuNum(){
            ...
            Random r=new Random();
            return  (2000+r.nextInt(42))+""+stuNum;
        }
        //密码 暂时不采用随机生成
        //真实名字
        public static String name(){
//            String generatedName = ChineseNameGenerator.getInstance().generateOdd();//繁体
            String generatedName = ChineseNameGenerator.getInstance().generate(); //简体
            return  generatedName;
        }

    public static String userName(){
        String generatedName = EnglishNameGenerator.getInstance().generate();
        String userName=generatedName.replaceAll(" ","");
        return  userName;
    }
