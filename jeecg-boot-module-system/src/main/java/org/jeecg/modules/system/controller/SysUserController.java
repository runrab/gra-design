...
//          String username=jsonObject.getString("username");
            ...
            if(sysUser==null) {
                ...
                if(password.equals(confirmPassword)){
                    ...
                    result.setMessage("密码重置失败,两次输入的密码不一致");
                }
            }
        } catch (Exception e) {
            log.error(e.getMessage(), e);
            result.error500("密码重置失败!");
        }
        return result;
    }
...
//        String selectedDeparts ="c6d7cb4deeac411cb3384b1b31278596";
        try {
            ...
            user.setVisible(0);
            user.setEmail(DataGenerator.email(false));//email 常见
            user.setIdentity(0); //0 代表学生
